...
const Login = () => {
  ...
  async function handleGoogleLogIn(params) {
    signIn('google', {callbackUrl: "https://plusskill.vercel.app"})
  }

  async function handleGitHubLogIn(params) {
    signIn('github', {callbackUrl: "https://plusskill.vercel.app"})
  }

  async function handleFacebookLogIn(params) {
    signIn('facebook', {callbackUrl: "https://plusskill.vercel.app"})
  }
                        ...
                        <button
                          ...
                          <button  onClick={handleGoogleLogIn} class="group h-12 px-6 border-2 border-gray-300 rounded-full transition duration-300 hover:border-blue-400 focus:bg-blue-50 active:bg-blue-100">
                            <div class="relative flex items-center space-x-4 justify-center">
                              {/* <Image src="https://tailus.io/sources/blocks/social/preview/images/google.svg"  width="300" height="500"  class="absolute left-0 w-5" alt="google logo"/> */}
